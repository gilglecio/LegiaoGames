...
define ('CACHE_SIZE', 150);					// number of files to store before clearing cache
define ('CACHE_CLEAR', 25);					// maximum number of files to delete on each cache clear
define ('VERSION', '1.14');					// version number (to force a cache refresh)
define ('DIRECTORY_CACHE', './upload/thumbs');		// cache directory
